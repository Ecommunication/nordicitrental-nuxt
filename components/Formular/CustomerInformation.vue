...
{
  "en": {
"billingDetails":"Billing infomation",
"phone":"Phone",
"email": "E-mail",
"cvr":"CVR Number",
"shipDiffrentAddress":" Ship the products to a diffrent address?",
"shippingAddress":"Shipping address",
"remarks":"Remarks for the order (optional):",
"orderNow":"CONFIRM ORDER"
  },
  "da": {
"billingDetails":"Faktureringsoplysninger",
"phone":"Telefon",
"email": "E-mail",
"cvr":"CVR nummer",
"shipDiffrentAddress":"Send varerne til en anden adresse?",
"shippingAddress":"Leveringsadresse",
"remarks":" Bemærkninger til ordren (valgrit):",
"orderNow":"BESTIL ORDRE"
  }
}
</i18n>
...
<template>
  <div>
    <div class="title1 mb-2">{{ $t('billingDetails') }}</div>
    <div class="customer-contact-form">
      ...
      >
        <div class="form-title">{{ $t('shippingAddress') }}</div>
        <!-- Shipping Address -->
        <AddressForm
          class="form-body"
