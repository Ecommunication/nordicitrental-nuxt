  ...
  <div class="index" v-else>
      ...
      <div class="wrap-grid wrap-5 index-categories mt-3 mb-3">
        ...
        >
          <span v-if="cat.Image.url"
            ><img class="mx-auto" :src="cat.Image.url | formatImage"
          /></span>
    ...
    <div class="grid-full bg-gray-light mt-20 pb-20">
      <div class="flex flex-wrap flex-justify-center pt-10 pb-10">
        <h3 class="text-blue title-md weight-thin">
      ...
      <div class="grid-wide wrap-grid wrap-4 mt-3">
        ...
        >
          <div class="h-80">
            <span v-if="item.Icon.url"
              ><img class="mx-auto" :src="item.Icon.url | formatImage"
            /></span>
          </div>
          <div>
            <span class="block mt-1 mb-1 text-md text-blue weight-bold">{{
              item.Title
            }}</span>
    ...
    <div class="grid-wide wrap-grid wrap-4">
      ...
      >
        ...
        <span><img :src="item.Icon.url | formatImage"/></span>
    ...
    <div class="bg-blue pt-20 pb-20">
      <div class="grid-wide">
        <div class="wrap-grid wrap-4">
          ...
          >
            <span
              ><img :src="item.Reference[0].url | formatImage" alt=""
            /></span>
          </div>
        </div>
      </div>
